...
static asn_per_constraints_t asn_PER_memb_rsiId_constr_5 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8,  0,  255 }	/* (0..255) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_description_constr_7 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_RoadSideInformation_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct RoadSideInformation, description),
		...
		&asn_PER_memb_description_constr_7,
		0,
		"description"
		},
